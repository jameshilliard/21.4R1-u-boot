 ...
 * $Id$
 *
 * tsec.c -- Freescale Three Speed Ethernet Controller driver
 *
 * Rajat Jain, Feb 2011
 *
...
int tsec_initialize(bd_t * bis, int index, char *devname)
{
	...
	/*
	 * Only eTSEC1 (fxp0) supports PHY.
	 * Skip PHY initialization for other eTSEC controllers.
	 */
	if (!strcmp(dev->name, CONFIG_MPC85XX_TSEC1_NAME)) {
		return init_phy(dev);
	} else {
...
struct phy_info phy_info_BCM54610 = {
	0x0143BD6,	/* 54610 ID */
	"Broadcom BCM54610",
	4, /* Last 4 bits are revision numbers */
	(struct phy_cmd[]) { /* config */
		/* Reset and configure the PHY */
		{MIIM_CONTROL, MIIM_CONTROL_RESET, NULL},
		{MIIM_GBIT_CONTROL, MIIM_GBIT_CONTROL_INIT, NULL},
