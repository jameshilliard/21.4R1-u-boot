...
#define TBI_CR                      0x0000 /* Control */
#define TBI_SR                      0x0001 /* Status */
#define TBI_ANA                     0x0004 /* AN Advertisement */
#define TBI_ANLPBPA                 0x0005 /* AN link partner base page ability */
#define TBI_ANEX                    0x0006 /* AN Expansion */
#define TBI_ANNPT                   0x0007 /* AN next page transmit */
#define TBI_ANLPANP                 0x0008 /* AN link partner ability next page */
#define TBI_EXST                    0x000f /* Extended Status */
#define TBI_JD                      0x0010 /* Jitter Diagnostics */
#define TBI_TBICON                  0x0011 /* TBI Control */
#define TBI_AN_ABLE                 0x0008 /* Device is capable of AN */
#define TBI_AN_COMP                 0x0020 /* AN completed */
#define TBI_LINK_STS                0x0004  /* TBI Link status */
...
#define ECNTRL_SGMII_INIT_SETTINGS	0x00001022
#define ECNTRL_TBI_MODE		0x00000020
#define ECNTRL_R100		0x00000008

#define miim_and_write		(-8) /* read modify and write */
#define miim_or_write		(-7) /* read modify OR write */
#define miim_sh_and_write	(-6) /* Shadow read modify AND write */
#define miim_sh_or_write	(-5) /* Shadow read modify OR write */
#define miim_write		(-4) /* normal reg write */
#define miim_sh_read		(-3) /* Shadow read */
#define miim_end			(-2) 
#define miim_read			(-1) /* normal register read*/
...
#define MIIM_88E1112_PHY_LED_CONTROL	16
#define MIIM_88E1112_PHY_LED_DEFAULT	0x1000
...
/*Broadcom 5466R registers for Caffeine*/
...
struct phy_cmd {
#ifdef CONFIG_EX82XX
    uint mii_op; /* Operation - Read , write etc */
#endif 
    uint mii_reg;
    uint mii_data;
...
struct phy_info {
    ...
    char *name;
#ifdef CONFIG_EX82XX
    uint if_id; /* Interface ID if the phy supports more than one interface*/
#endif
    uint shift;
