...
extern void pcie_setup_indirect(struct pcie_controller* hose, 
								unsigned int cfg_addr, unsigned int cfg_data);

void pcie_mpc85xx_init(struct pcie_controller *hose, PARAM_PCIE *pcie_info)
{
	volatile immap_t    *immap = (immap_t *)CFG_CCSRBAR;
	volatile ccsr_pcie_t *pcie =  (ccsr_pcie_t *) (CFG_PCIE2_ADDR);
...
#define PCIE_TRANSLATION_ADDR_BASE 0x04000000 /* TARGET's DDR MEMORY BASE for EP PCIE memory space */ 
	...
	/* BUG FIX for PCIE EP mode */
		...
		/* Inbound ATMU : DRAM starts at Address 0 and size = 2G */
...
#else
		pcie->iwar1 = (PIWAR_EN | PIWAR_PF | PIWAR_LOCAL |
					PIWAR_READ_SNOOP | PIWAR_WRITE_SNOOP | PIWAR_MEM_1G);
#endif
