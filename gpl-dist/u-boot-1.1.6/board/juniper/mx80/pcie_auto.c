...
static void pcie_auto_prescan_setup_bridge(struct pcie_controller *, pcie_dev_t, int);
static void pcie_auto_postscan_setup_bridge(struct pcie_controller *, pcie_dev_t, int);
...
int pcie_auto_config_device(struct pcie_controller *hose, pcie_dev_t dev)
{
	...
	switch(class) {
	case 0xb20:/* PCIE_CLASS_PROCESSOR_POWERPC */
