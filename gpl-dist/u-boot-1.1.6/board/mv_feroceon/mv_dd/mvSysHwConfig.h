...
#undef MV_INC_BOARD_NOR_FLASH
#undef MV_INC_BOARD_PCI_SATA
#undef MV_INC_BOARD_RTC

#undef MV_INC_BOARD_NAND_FLASH

#undef CFG_DRAM_BANKS
#undef MV_INCLUDE_MONT_FFS
...
#ifdef EX3300
#undef BOOT_FLASH_INDEX
#define BOOT_FLASH_INDEX                    0
/* Device CS0 - NAND, CS1 - SYSPLD, CS2 -NC, CS3 - NC, BootCS - NC */
#undef DEVICE_CS0_BASE
#undef DEVICE_CS0_SIZE
#undef DEVICE_CS1_BASE
#undef DEVICE_CS1_SIZE
#undef DEVICE_SPI_BASE
#undef DEVICE_SPI_SIZE
#undef BOOTDEV_CS_BASE
#undef BOOTDEV_CS_SIZE

#undef PCI0_MEM0_BASE
#undef PCI0_MEM0_SIZE
#undef PCI4_MEM0_BASE
#undef PCI4_MEM0_SIZE

#define PCI0_MEM0_BASE  0xc0000000
#define PCI0_MEM0_SIZE  _128M
#define PCI4_MEM0_BASE  0xc8000000
#define PCI4_MEM0_SIZE  _128M

#define DEVICE_CS0_BASE 0xFC000000
#define DEVICE_CS0_SIZE _32M

#define DEVICE_CS1_BASE 0xFF700000
#define DEVICE_CS1_SIZE _1M

#define DEVICE_SPI_BASE 0xFF800000
...
/*     	base low      base high      size        	WinNum		enable/disable */ \
	...
	{{PCI0_IO_BASE   ,    0,      PCI0_IO_SIZE   }, 0,		DIS },/*  9 */ \
	{{PCI0_MEM0_BASE ,    0,      PCI0_MEM0_SIZE }, 1,		EN },/* 10 */ \
	{{PCI1_IO_BASE   ,    0,      PCI1_IO_SIZE   }, 2,		DIS },/* 11 */ \
	{{PCI1_MEM0_BASE ,    0,      PCI1_MEM0_SIZE }, 3,		DIS },/* 12 */ \
	{{PCI2_IO_BASE   ,    0,      PCI2_IO_SIZE   }, 4,		DIS},/* 13 */ \
	{{PCI2_MEM0_BASE ,    0,      PCI2_MEM0_SIZE }, 5,		DIS},/* 14 */ \
	{{PCI3_IO_BASE   ,    0,      PCI3_IO_SIZE   }, 4,		DIS },/* 15 */ \
	{{PCI3_MEM0_BASE ,    0,      PCI3_MEM0_SIZE }, 5,		DIS },/* 16 */ \
	{{PCI4_IO_BASE   ,    0,      PCI4_IO_SIZE   }, 6,		DIS },/* 17 */ \
	...
	{{CRYPTO_BASE ,	      0,      CRYPTO_SIZE    }, 8,		DIS },/* 25 */ \
...
/*     	base low      base high      size        	WinNum		enable/disable */ \
	...
	{{BOOTDEV_CS_BASE,    0,      BOOTDEV_CS_SIZE}, 13,		EN },/*  8 */ \
	{{PCI0_IO_BASE   ,    0,      PCI0_IO_SIZE   }, 0,		DIS },/*  9 */ \
	{{PCI0_MEM0_ME_BASE,  0,      PCI0_MEM0_ME_SIZE }, 1,		EN },/* 10 */ \
	{{PCI1_IO_BASE   ,    0,      PCI1_IO_SIZE   }, 2,		DIS },/* 11 */ \
	{{PCI1_MEM0_ME_BASE,  0,      PCI1_MEM0_ME_SIZE }, 3,		DIS },/* 12 */ \
	{{PCI2_IO_BASE   ,    0,      PCI2_IO_SIZE   }, 4,		DIS},/* 13 */ \
	{{PCI2_MEM0_ME_BASE , 0,      PCI2_MEM0_ME_SIZE }, 5,		DIS},/* 14 */ \
	{{PCI3_IO_BASE   ,    0,      PCI3_IO_SIZE   }, 4,		DIS },/* 15 */ \
	{{PCI3_MEM0_ME_BASE,  0,      PCI3_MEM0_ME_SIZE }, 5,		DIS },/* 16 */ \
	{{PCI4_IO_BASE   ,    0,      PCI4_IO_SIZE   }, 6,		DIS},/* 17 */ \
	{{PCI4_MEM0_ME_BASE,  0,      PCI4_MEM0_ME_SIZE }, 7,		EN },/* 18 */ \
	{{PCI5_IO_BASE   ,    0,      PCI5_IO_SIZE   }, 5,		DIS},/* 19 */ \
	{{PCI5_MEM0_ME_BASE , 0,      PCI5_MEM0_ME_SIZE }, 5,		DIS},/* 20 */ \
	{{PCI6_IO_BASE   ,    0,      PCI6_IO_SIZE   }, 6,		DIS},/* 21 */ \
	{{PCI6_MEM0_ME_BASE , 0,      PCI6_MEM0_ME_SIZE }, 6,		DIS},/* 22 */ \
	{{PCI7_IO_BASE   ,    0,      PCI7_IO_SIZE   }, 7,		DIS},/* 23 */ \
	{{PCI7_MEM0_ME_BASE , 0,      PCI7_MEM0_ME_SIZE }, 7,		DIS},/* 24 */ \
	{{CRYPTO_BASE ,	      0,      CRYPTO_SIZE    }, 8,		DIS },/* 25 */ \
	{{INTER_REGS_BASE,    0,      INTER_REGS_SIZE}, 14,		EN },/* 26 */ \
    	/* Table terminator */ \
   	{{TBL_TERM, TBL_TERM, TBL_TERM}, TBL_TERM, TBL_TERM} \
