...
/* Don't support commands on production images */
#ifdef DEBUG
...
extern void fixup_cmdtable(cmd_tbl_t *cmdtp, int size);
...
static int do_tpm(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	...
	if (strcmp(argv[1],"init") == 0) {
	    return_val = do_tpm_init(cmdtp, flag, argc - 1, argv + 1);
	    if(return_val == TPM_SUCCESS); 
		print_dev_vendor_name();
	}
	else if (strcmp(argv[1],"startup") == 0)
	    return_val = do_tpm_startup(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"self_test_full") == 0)
	    return_val = do_tpm_self_test_full(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"continue_self_test") == 0)
	    return_val = do_tpm_continue_self_test(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"force_clear") == 0)
	    return_val = do_tpm_force_clear(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"physical_enable") == 0)
	    return_val = do_tpm_physical_enable(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"physical_disable") == 0)
	    return_val = do_tpm_physical_disable(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"nv_define_space") == 0)
            return_val = do_tpm_nv_define_space(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"nv_read_value") == 0)
	    return_val = do_tpm_nv_read_value(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"nv_write_value") == 0)
	    return_val = do_tpm_nv_write_value(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"extend") == 0)
	    return_val = do_tpm_extend(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"pcr_read") == 0)
	    return_val = do_tpm_pcr_read(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"tsc_physical_presence") == 0)
	    return_val = do_tpm_tsc_physical_presence(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"read_pubek") == 0)
	    return_val = do_tpm_read_pubek(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"physical_set_deactivated") == 0)
	    return_val = do_tpm_physical_set_deactivated(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"get_capability") == 0)
	    return_val = do_tpm_get_capability(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"raw_transfer") == 0)
	    return_val = do_tpm_raw_transfer(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"nv_define") == 0)
	    return_val = do_tpm_nv_define(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"nv_read") == 0)
	    return_val = do_tpm_nv_read(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"nv_write") == 0)
	    return_val = do_tpm_nv_write(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"oiap") == 0)
	    return_val = do_tpm_oiap(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"end_oiap") == 0)
	    return_val = do_tpm_end_oiap(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"load_key2_oiap") == 0)
	    return_val = do_tpm_load_key2_oiap(cmdtp, flag, argc - 1, argv + 1);
	else if (strcmp(argv[1],"get_pub_key_oiap") == 0)
	    return_val = do_tpm_get_pub_key_oiap(cmdtp, flag, argc - 1, argv + 1);
	else printf("\n TPM command not recognized \n");
