...
/* Junos start */
/*
 * Set our working FDT address, copied from cmd_fdt.c as command to do_fdt
 * is not supported. in U-Boot 1.1.6 we are not using FDT, so not ported
 */
void br_set_working_fdt_addr(void *addr)
{
	void *buf;
...
int boot_relocate_fdt(struct lmb *lmb, char **of_flat_tree, ulong *of_size)
{
	...
	*of_size = of_len;
	...
	/* Junos start */
	br_set_working_fdt_addr(*of_flat_tree);
	/* Junos end */
	return 0;
