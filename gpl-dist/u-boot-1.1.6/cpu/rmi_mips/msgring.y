...
#define MAX_RX_STNS ((int)(sizeof(rx_stns)/sizeof(struct rx_stn)) - 1)
 ...
 static struct rx_bucket rx_buckets[] = {
   ...
   {.name = "gmac_jfr_0" , .rx_stn_name = "RX_STN_GMAC" },
   ...
   {.name = "gmac_jfr_1" , .rx_stn_name = "RX_STN_GMAC" },
   {.name = "gmac_rfr_1" , .rx_stn_name = "RX_STN_GMAC" },

   {.name = "dma_rsvd_0" , .rx_stn_name = "RX_STN_DMA" },
   {.name = "dma_rsvd_1", .rx_stn_name = "RX_STN_DMA" },
   {.name = "dma_rsvd_2", .rx_stn_name = "RX_STN_DMA" },
   {.name = "dma_rsvd_3", .rx_stn_name = "RX_STN_DMA" },
   ...
   {.name = "xgs_0_jfr", .rx_stn_name = "RX_STN_XGS_0_FR" },
   {.name = "xgs_0_rfr", .rx_stn_name = "RX_STN_XGS_0_FR" },

   {.name = "xgs_1_jfr", .rx_stn_name = "RX_STN_XGS_1_FR" },
...
static void gen_tables(void)
{
  ...
  for(i=0; tx_stns[i].name; i++) {
    sprintf(line, "struct stn_cc cc_table_%s = {{\n\t\t", tx_stns[i].tbl_name);
    fwrite(line, strlen(line), 1, fp);
