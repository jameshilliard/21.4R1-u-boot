...
typedef struct ccsr_i2c {
	...
	|| defined(CONFIG_MPC8533) \
	|| defined(CONFIG_MPC8544) \
...
#else
	char	res8[8];
	uint	fmr;            /* Flash Mode Register */
	uint	fir;            /* Flash Instruction Register */
	uint	fcr;            /* Flash Command Register */
	uint	fbar;           /* Flash Block Addr Register */
	uint	fpar;           /* Flash Page Addr Register */
	uint	fbcr;           /* Flash Byte Count Register */
	char	res9[3848];
#endif
} ccsr_lbc_t;
...
#define POWAR_MEM_256M	0x0000001b
#define POWAR_MEM_512M	0x0000001c
#define POWAR_MEM_1G	0x0000001d
...
#define PIWAR_MEM_256M		0x0000001b
#define PIWAR_MEM_512M		0x0000001c
#define PIWAR_MEM_1G		0x0000001d
...
typedef struct ccsr_pcie{
	uint cfg_addr;	/* 0xa000 - PCI-Express Configuration Address Register */
	uint cfg_data;	/* 0xa004 - PCI-Express Configuration Data Register */
	char res1[4];
	uint otb_cpl_tout;	/* 0xa00c - PCI-Express Outbound Completion Timeout Register */
	uint cfg_rty_tout;	/* 0xa010 - PCI-Express Configuration Retry Timeout Register */
	uint cfg_reg;	/* 0xa014 - PCI-Express Configuration Register */
	char res2[8];
	uint pme_mes_dr;	/* 0xa020 - PCI-Express PME And Message Detect Register */						    
	uint pme_mes_disr;	/* 0xa024 - PCI-Express PME And Message Disable Register */
	uint pme_mes_ier;	/* 0xa028 - PCI-Express PME And Message Interrupt Enable Register */
	uint pmcr;	/* 0xa02c - PCI-Express Power Management Command Register */
	char res3[3016];
	uint ipblk_rev_reg1;	/* 0xabf8 - PCI-Express IP Block Revision Register 1 */
	uint ipblk_rev_reg2;	/* 0xabfc - PCI-Express IP Block Revision Register 2 */
	uint otar0;	/* 0xac00 - PCI-Express Outbound Translation Address Register0 */
	uint otear0;	/* 0xac04 - PCI-Express Outbound Translation Extented Address Register0 */
	char res4[8];
	uint owar0;	/* 0xac10 - PCI-Express Outbound Window Attribute Register */
	char res5[12];
	uint otar1;	/* 0xac20 - PCI-Express Outbound Translation Address Register1 */
	uint otear1;	/* 0xac24 - PCI-Express Outbound Translation Extented Address Register1 */
	uint owbar1;	/* 0xac28 - PCI-Express Outbound Window Base Address Register1 */
	char res6[4];
	uint owar1;	/* 0xac30 - PCI-Express Outbound Window Attribute Register1 */
	char res7[12];
	uint otar2;	/* 0xac40 = PCI-Express Outbound Translation Address Register2 */
	uint otear2;	/* 0xac44 - PCI-Express Outbound Transaction Extented Address Register2 */
	uint owbar2;	/* 0xac48 - PCI-Express Outbound Window Base Address Register2 */
	char res8[4];
	uint owar2;	/* 0xac50 - PCI-Express Outbound Window Attribute Register2 */
	char res9[12];
	uint otar3;	/* 0xac60 - PCI-Express Outbound Transaction Address Register3 */
	uint otear3;	/* 0xac64 - PCI-Express Outbound Transaction Extented Address Register3 */
	uint owbar3;	/* 0xac68 - PCI-Express Outbound Window Base Address Register3 */
	char res10[4];
	uint owar3;	/* 0xac70 - PCI-Express Outbound Window Attribute Register3 */
	char res11[12];
	uint otar4;	/* 0xac80 - PCI-Express Outbound Transaction Address Register4 */
	uint otear4;	/* 0xac84 - PCI-Express Outbound Transaction Extented Address Register4 */
	uint owbar4;	/* 0xac88 - PCI-Express Outbound Window Base Address Register4 */
	char res12[4];
	uint owar4;	/* 0xac90 - PCI-Express Outbound Window Attribute Register4 */
	char res13[268];
	uint itar3;	/* 0xada0 - PCI-Express Inbound Transaction Address Register3 */
	char res14[4];
	uint iwbar3;	/* 0xada8 - PCI-Express Inbound Window Base Address Register3 */
	uint iwbear3;	/* 0xadac - PCI-Express Inbound Window Base Extented Address Register3 */
	uint iwar3;	/* 0xadb0 - PCI-Express Inbound Window Attribute Register3 */
	char res15[12];
	uint itar2;	/* 0xadc0 - PCI-Express Inbound Transaction Address Register2 */
	char res16[4];
	uint iwbar2;	/* 0xadc8 - PCI-Express Inbound Window Base Address Register2 */
	uint iwbear2;	/* 0xadcc - PCI-Express Inbound Window Base Extented Address Register2 */
	uint iwar2;	/* 0xadd0 - PCI-Express Inbound Window Attribute Register2 */
	char res17[12];
	uint itar1;	/* 0xade0 - PCI-Express Inbound Transaction Address Register1 */
	char res18[4];
	uint iwbar1;	/* 0xade8 - PCI-Express Inbound Window Base Address Register1 */
	char res19[4];
	uint iwar1;	/* 0xadf0 - PCI-Express Inbound Window Attribute Register1 */
	char res20[12];
	uint err_dr;	/* 0xae00 - PCI-Express Error Detect Register */
	char res21[4];
	uint err_en;	/* 0xae08 - PCI-Express Error Interrupt Enable Register */
	char res22[4];
	uint err_disr;	/* 0xae10 - PCI-Express Error Disable Register */
	char res23[12];
	uint err_cap_stat;	/* 0xae20 - PCI-Express Error Capture Status Register */
	char res24[4];
	uint err_cap_r0;	/* 0xae28 - PCI-Express Error Capture Register 0 */
	uint err_cap_r1;	/* 0xae2c - PCI-Express Error Capture Register 1 */
	uint err_cap_r2;	/* 0xae30 - PCI-Express Error Capture Register 2 */
	uint err_cap_r3;	/* 0xae34 - PCI-Express Error Capture Register 3 */
	char res25[456];
}ccsr_pcie_t;
...
typedef struct ccsr_pic {
	...
	char 	res0[98304];	/* 0x28000-0x40000 */
#else
...
#define MPC85xx_PORPLLSR_E500_0_RATIO   0x003f0000
#define MPC85xx_PORPLLSR_E500_1_RATIO   0x3f000000
...
#else
	ccsr_pcix_t		im_pcix;
#if defined(CONFIG_MPC8533) || defined(CONFIG_MPC8544)
	ccsr_pcie_t		im_pex2;
	ccsr_pcie_t		im_pex1;
	ccsr_pcie_t		im_pex3;
	char			reserved[81920];
