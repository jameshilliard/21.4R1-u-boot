...
/* Bit flags that indidate which address space register is in */
#define ATA_IO_DATA_FLAG    (0x100)
#define ATA_IO_REG_FLAG     (0x200)
#define ATA_IO_ALT_FLAG     (0x400)
#define ATA_IO_DATA(x)	(ATA_IO_DATA_FLAG+((x) * CFG_ATA_STRIDE))
#define ATA_IO_REG(x)	(ATA_IO_REG_FLAG +((x) * CFG_ATA_STRIDE))
#define ATA_IO_ALT(x)	(ATA_IO_ALT_FLAG +((x) * CFG_ATA_STRIDE))
...
#define ATA_RESET_TIME	5	/* spec allows up to 31 seconds */
#endif
...
/* defines for SII 0x680 pci ata controller used on jsrxnle platfoms to 
 * provide support for compact flash                                    
 */                                                                     
                                                                        
#define SII_ATA_DATA 0x80                                               
#define SII_ATA_FEATURES_ERR  0x81                                      
#define SII_ATA_SECT_CNT 0x82                                           
#define SII_ATA_SECT_NUM 0x83                                           
#define SII_ATA_CYL_LOW 0x84                                            
#define SII_ATA_CYL_HIGH 0x85                                           
#define SII_ATA_DEV_HEAD 0x86                                           
#define SII_ATA_CMD_STUS  0x87                                          
                                                                        
#define SII_ATA_IDE0_CONFIG 0xa1                                        
#define SII_ATA_IDE0_TF_TIMING   0xa2                                   
#define SII_ATA_IDE0_DMA_TIMING 0xa8                                    
#define SII_ATA_IDE0_UDMA_TIMING 0xac                                   
#define SII_ATA_IDE0_DATA_TXFER_MODE 0xb4                               
                                                                        
                                                                        
#define SII_ATA_IDE1_CONFIG 0xe1                                        
#define SII_ATA_IDE1_TF_TIMING   0xe2                                   
#define SII_ATA_IDE1_DMA_TIMING 0xe8                                    
#define SII_ATA_IDE1_UDMA_TIMING 0xec                                   
#define SII_ATA_IDE1_DATA_TXFER_MODE 0xf4                               
#define SII_IDE0_DEVICE_CTRL 0x8a                                       
                                                                        
                                                                        
#define IDE_DEVICE0 0xE0                                                
#define IDE_NO_INT 0xa                                                  
#define IDE_NOP 0x0                                                     
                                                                        
#define IDE_RDY_CNT 20000                                               
#define IDE_BUSY 0x80                                                   
#define IDE_ERR 0x1                                                     
#define IDE_ABORT 0x4                                                   
#define IDE_XFER_MODE 0x03                                              
#define IDE_PIO_MODE0 0x8                                               
#define IDE_BYTE_XFER_MODE 0x1                                          
