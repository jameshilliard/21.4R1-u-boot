 ...
 * $Id$
 *
 * acx_icrt.h -- iCRT for ACX Board configuration file
 *
...
#define CFG_MEMTEST_INCR	0x00000010  /* Should be in multiples 
					       of 4 bytes */
 ...
 * For iCRT, network support is not required, hence disable the network
 * init etc.
 */
...
#define CONFIG_IPADDR		10.216.66.70	/* kotinos-i03-p1a */
...
#define	CONFIG_EXTRA_ENV_SETTINGS				\
    "getnew=tftp 0x1000000 bootstore/kotinos/acx_icrt-ro-uboot.bin; protect off 0xfff60000 0xffffffff; erase 0xfff60000 0xffffffff; cp.b 0x1000000 0xfff80000 0x80000;"\
