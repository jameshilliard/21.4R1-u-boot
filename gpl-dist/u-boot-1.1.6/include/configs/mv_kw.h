...
/************/
#ifdef MV_TINY_IMAGE
#define CONFIG_IDENT_STRING	" Marvell version: 3.4.9.3-TINY"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 3.4.9.3"
#endif /* MV_TINY_IMAGE */
/* version number passing when loading Kernel */
/* NOTE: last byte is used for boardID on Linux boot time. 
 * must be zeroed here 						*/
#define VER_NUM 0x03040900           /* 3.4.9 */
...
/*  	#define CFG_MONITOR_LEN			(512 << 10)TODO - Haim Remove	*//* Reserve 512 kB for Monitor */
  	#define CFG_MONITOR_LEN			(640 << 10)	/* Reserve 640 kB for Monitor */
 #endif								 
...
#define CFG_APPL_PART_UBOOT_SIZE  (CFG_MONITOR_LEN + CFG_ENV_SECT_SIZE) // 

#define CFG_APPL_PART_KERNEL_START (CFG_APPL_PART_UBOOT_START + CFG_APPL_PART_UBOOT_SIZE)
#define CFG_APPL_PART_KERNEL_SIZE  (0x00300000) // 3MB
