...
void i2c_init(uchar chanNum, int speed, int slaveaddr);
#else
 ...
 */
#if defined(CONFIG_MARVELL)
int i2c_read(uchar chanNum, uchar chip, uint addr, int alen, uchar *buffer, int len);
int i2c_write(uchar chanNum, uchar chip, uint addr, int alen, uchar *buffer, int len);
#else
