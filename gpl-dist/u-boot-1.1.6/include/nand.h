...
int nand_erase_rw ( ulong nand_offset, ulong nand_length, int test_count); 
...
#define NAND_SIZE_ERR   1
#define NAND_ERASE_ERR  2
#define NAND_WRITE_ERR  3
#define NAND_READ_ERR   4
#define NAND_VERIFY_ERR 5 
