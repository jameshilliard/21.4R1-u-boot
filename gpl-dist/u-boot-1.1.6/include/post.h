...
#define CFG_POST_PCI		0x00004000
#define CFG_POST_MEMORY_RAM	0x00010000
#define CFG_POST_SYSPLD     0x00020000
#define CFG_POST_SUMATRA    0x00008000
#define CFG_POST_EEPROM     0x00040000
#define CFG_POST_MEMORY_ADDR_RAM          0x00080000
#define CFG_POST_MEMORY_SLOW_TEST_RAM     0x00100000
#define CFG_POST_UBOOT_CRC                0x00200000
#define CFG_POST_CPLD		0x00400000
#define CFG_POST_PCIE		0x00800000
#define CFG_POST_NAND		0x01000000
#define CFG_POST_SECUREBOOT     0x02000000
