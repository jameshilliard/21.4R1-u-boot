...
#ifdef DEBUG
	/* Decrypt the signature and display it for debug purpose */
        /* destination for decrypted signature */
        unsigned char clear_buf[768];
        unsigned int i = 0;
        int num_bytes = 0;
        ...
        printf("\n cleared buffer before reading data");
        
	num_bytes=RSA_public_decrypt( *sig_len, *sigp, clear_buf, rsa, RSA_NO_PADDING);
