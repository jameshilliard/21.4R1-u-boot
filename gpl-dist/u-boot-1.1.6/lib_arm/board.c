...
extern void recoveryCheck(void);
    ...
    defined(CONFIG_EX3300) || \
    defined(CONFIG_RPS200)
extern int32_t exflashInit (void);
...
void mem_malloc_init (ulong dest_addr)
{
    ...
    defined(CONFIG_EX3300) || \
    defined(CONFIG_RPS200)
        mem_malloc_end = CFG_MALLOC_BASE  + CFG_MALLOC_LEN - CFG_GBL_DATA_SIZE;
...
#endif
#if defined(CONFIG_DISPLAY_BOARDINFO) || defined(CONFIG_VCMA9) || defined (CONFIG_CMC_PU2)
...
void ex_post_run (void);
    ...
    defined(CONFIG_EX3300) || \
    defined(CONFIG_RPS200)
	gd = (gd_t*)(CFG_MALLOC_BASE + (1 << 20) - sizeof(gd_t));
#else
