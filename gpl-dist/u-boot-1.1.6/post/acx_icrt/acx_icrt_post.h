 ...
 * $Id$
 *
 * acx_icrt_post.h -- Common macros for debugging during POST
 *
...
extern uint32_t nvram_get_uboot_sreset_test(void);
extern void nvram_set_uboot_sreset_test(uint32_t);
