 ...
 * $Id$
 *
 * tests.c -- List of diagnostics on the iCRT platform
 *
...
extern int secureboot_uart_post_test(int flags);
...
struct post_test post_list[] =
{
	...
	{
		"UART transmit/receive disable test",
		"uartcontrol",
		"This test verifies the UART transmit/receive disable "\
			"functionality of the chassis",
		POST_RAM | POST_MANUAL,
		&secureboot_uart_post_test,
		NULL,
		NULL,
		CFG_POST_SECUREBOOT
	},
