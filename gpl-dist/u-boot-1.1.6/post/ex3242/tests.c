...
struct post_test post_list[] =
{
	...
	" Tests address bus,data buss and memory location",
...
#if CONFIG_POST & CFG_POST_PCI
	{
		"PCI test",
		"pci",
		"This test verifies the PCI operation.",
		POST_RAM | POST_ALWAYS | POST_MANUAL,
		&pci_post_test,
		NULL,
		NULL,
...
#endif
#if CONFIG_POST & CFG_POST_SUMATRA
	{
		"Sumatra test",
		"sumatra",
		"This tests performs  diag of memory, pci,i2c and usb devices - ",
		0,
		NULL,
		NULL,
		NULL,
