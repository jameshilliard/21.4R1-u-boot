...
struct tsec_device etsec_dev[] =
    {
     {CONFIG_MPC85XX_TSEC1_NAME, 1<<LB_MAC | 1<<LB_PHY1145},
     {CONFIG_MPC85XX_TSEC2_NAME, 1<<LB_MAC | 1<<LB_PHY1145},
     {CONFIG_MPC85XX_TSEC3_NAME, 1<<LB_MAC | 1<<LB_PHY1145},
     {CONFIG_MPC85XX_TSEC4_NAME, 1<<LB_MAC | 1<<LB_PHY1145 |
        1<<LB_PHY1112 |1<<LB_EXT_10 |1<<LB_EXT_100 | 1<<LB_EXT_1000},
     {NULL , 0}
    };

struct tsec_device post_etsec_dev[] =
    {{CONFIG_MPC85XX_TSEC4_NAME, LB_MAC | 1<<LB_PHY1145 |1<<LB_PHY1112},
     {NULL , 0}
    };
...
phy_1112_loopback (struct eth_device *dev, int enable, int *link)
{
    ...
    volatile tsec_t *regs = priv->phyregs;
