...
extern int memory_address_post_test_diag(int flags);
extern int memory_post_slow_ram_test_diag(int flags);
...
struct post_test post_list[] =
{
	...
	{
		"The test validate address lines of ram",
		"addrlinetest",
		" Testing memory address from 0x100000 to 0x3FE00000"
		" data value being equal to address line",
		POST_RAM | POST_ALWAYS | POST_MANUAL,
		&memory_address_post_test_diag,
		NULL,
		NULL,
	...
	{
		"The test validate memory address with different patterns",
		"slowramtest",
		" Testing memory address from 0x100000 to 0x3FE00000"
		" with different data patterns",
		POST_RAM | POST_ALWAYS | POST_MANUAL,
		&memory_post_slow_ram_test_diag,
		NULL,
		NULL,
