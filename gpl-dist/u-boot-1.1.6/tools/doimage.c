...
int main(int argc,char** argv)
{
	...
	unsigned int nandPageSize=0, hex_width=0,header_mode = HDR_IMG_ONE_FILE,ms_delay=0;
	...
	if (header_mode != HDR_ONLY)
	{
		...
		if (img == IMG_BOOTROM)
		{
			...
			/* calculate checsum */
			chsum32 = checksum32((u32)tmp1, fs_stat.st_size, 0);
...
void print_usage(void)
{
	...
	printf("    Marvell 88F6180 - Z0\n");
	printf("    Marvell 88F6192 - Z0\n");
	printf("    Marvell 88F6281 - Z0\n");
	printf("\n");
	printf("usage: \n");
