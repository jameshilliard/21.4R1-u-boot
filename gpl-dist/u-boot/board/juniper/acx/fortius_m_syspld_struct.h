 ...
 * All rights reserved.
 *
 * $Id: struct_h.c,v 1.12.9 Fri Jun 10 19:08:48 2011 prithiviraj Exp $
 */
...
typedef struct fortius_m_re_regs {
    volatile u_int8_t version;		/* 0x0 */
        ...
        #define   FORTIUS_M_RE_REGS_VERSION_RESET_VALUE 0x1
    ...
    volatile u_int8_t revision;		/* 0x1 */
        ...
        #define   FORTIUS_M_RE_REGS_REVISION_RESET_VALUE 0x1
    ...
    volatile u_int8_t compile_month;		/* 0x2 */
        ...
        #define   FORTIUS_M_RE_REGS_COMPILE_MONTH_RESET_VALUE 0x6
    ...
    volatile u_int8_t compile_day;		/* 0x3 */
        ...
        #define   FORTIUS_M_RE_REGS_COMPILE_DAY_RESET_VALUE 0x10
    ...
    volatile u_int8_t main_voltage_margin_ctrl2;		/* 0xc */
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL2_RSVD_SET(CUR, NEWVAL) ((((NEWVAL) << 6) & 0x000000c0) | ((CUR) & ~0x000000c0))
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL2_RSVD_GET(CUR) (((CUR) >> 6) & 0x00000003)
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL2_RSVD_MSB 7
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL2_RSVD_LSB 6
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL2_RSVD_FWIDTH 2
    ...
    volatile u_int8_t main_voltage_margin_ctrl3;		/* 0xd */
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL3_RSVD_SET(CUR, NEWVAL) ((((NEWVAL) << 4) & 0x000000f0) | ((CUR) & ~0x000000f0))
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL3_RSVD_GET(CUR) (((CUR) >> 4) & 0x0000000f)
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL3_RSVD_MSB 7
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL3_RSVD_LSB 4
        #define   FORTIUS_M_RE_REGS_MAIN_VOLTAGE_MARGIN_CTRL3_RSVD_FWIDTH 4
    ...
    volatile u_int8_t board_device_control;		/* 0x10 */
        ...
        #define   FORTIUS_M_RE_REGS_BOARD_DEVICE_CONTROL_FAN_OFF_SET(CUR, NEWVAL) ((((NEWVAL) << 3) & 0x00000008) | ((CUR) & ~0x00000008))
        #define   FORTIUS_M_RE_REGS_BOARD_DEVICE_CONTROL_FAN_OFF_GET(CUR) (((CUR) >> 3) & 0x00000001)
        #define   FORTIUS_M_RE_REGS_BOARD_DEVICE_CONTROL_FAN_OFF_MSB 3
        #define   FORTIUS_M_RE_REGS_BOARD_DEVICE_CONTROL_FAN_OFF_LSB 3
        #define   FORTIUS_M_RE_REGS_BOARD_DEVICE_CONTROL_FAN_OFF_FWIDTH 1
...
typedef struct fortius_m_pfe_regs {
    volatile u_int8_t version;		/* 0x0 */
        ...
        #define   FORTIUS_M_PFE_REGS_VERSION_RESET_VALUE 0x1
    ...
    volatile u_int8_t revision;		/* 0x1 */
        ...
        #define   FORTIUS_M_PFE_REGS_REVISION_RESET_VALUE 0x1
    ...
    volatile u_int8_t compile_month;		/* 0x2 */
        ...
        #define   FORTIUS_M_PFE_REGS_COMPILE_MONTH_RESET_VALUE 0x6
    ...
    volatile u_int8_t compile_day;		/* 0x3 */
        ...
        #define   FORTIUS_M_PFE_REGS_COMPILE_DAY_RESET_VALUE 0x10
    ...
    volatile u_int8_t int_enable4;		/* 0x17 */
        ...
        #define   FORTIUS_M_PFE_REGS_INT_ENABLE4_BCM54880E_INT_EN_SET(CUR, NEWVAL) ((((NEWVAL) << 3) & 0x00000008) | ((CUR) & ~0x00000008))
        #define   FORTIUS_M_PFE_REGS_INT_ENABLE4_BCM54880E_INT_EN_GET(CUR) (((CUR) >> 3) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_INT_ENABLE4_BCM54880E_INT_EN_MSB 3
        #define   FORTIUS_M_PFE_REGS_INT_ENABLE4_BCM54880E_INT_EN_LSB 3
        #define   FORTIUS_M_PFE_REGS_INT_ENABLE4_BCM54880E_INT_EN_FWIDTH 1
    ...
    volatile u_int8_t int_status4;		/* 0x1e */
        ...
        #define   FORTIUS_M_PFE_REGS_INT_STATUS4_BCM54880E_INT_SET(CUR, NEWVAL) ((((NEWVAL) << 3) & 0x00000008) | ((CUR) & ~0x00000008))
        #define   FORTIUS_M_PFE_REGS_INT_STATUS4_BCM54880E_INT_GET(CUR) (((CUR) >> 3) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_INT_STATUS4_BCM54880E_INT_MSB 3
        #define   FORTIUS_M_PFE_REGS_INT_STATUS4_BCM54880E_INT_LSB 3
        #define   FORTIUS_M_PFE_REGS_INT_STATUS4_BCM54880E_INT_FWIDTH 1
    ...
    volatile u_int8_t reset_cntrl1;		/* 0x22 */
        ...
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_MIC_MIIM_SEL_SET(CUR, NEWVAL) ((((NEWVAL) << 5) & 0x00000020) | ((CUR) & ~0x00000020))
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_MIC_MIIM_SEL_GET(CUR) (((CUR) >> 5) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_MIC_MIIM_SEL_MSB 5
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_MIC_MIIM_SEL_LSB 5
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_MIC_MIIM_SEL_FWIDTH 1
        ...
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_PHY_BCM54880E_RESET_SET(CUR, NEWVAL) (((NEWVAL) & 0x00000001) | ((CUR) & ~0x00000001))
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_PHY_BCM54880E_RESET_GET(CUR) ((CUR) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_PHY_BCM54880E_RESET_MSB 0
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_PHY_BCM54880E_RESET_LSB 0
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL1_PHY_BCM54880E_RESET_FWIDTH 1
    volatile u_int8_t reset_cntrl2;		/* 0x23 */
        ...
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL2_I2C_SW_3_RESET_SET(CUR, NEWVAL) ((((NEWVAL) << 5) & 0x00000020) | ((CUR) & ~0x00000020))
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL2_I2C_SW_3_RESET_GET(CUR) (((CUR) >> 5) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL2_I2C_SW_3_RESET_MSB 5
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL2_I2C_SW_3_RESET_LSB 5
        #define   FORTIUS_M_PFE_REGS_RESET_CNTRL2_I2C_SW_3_RESET_FWIDTH 1
    ...
    volatile u_int8_t module_status;		/* 0x24 */
        ...
        #define   FORTIUS_M_PFE_REGS_MODULE_STATUS_POE_MODULE_PRESENT_SET(CUR, NEWVAL) (((NEWVAL) & 0x00000001) | ((CUR) & ~0x00000001))
        #define   FORTIUS_M_PFE_REGS_MODULE_STATUS_POE_MODULE_PRESENT_GET(CUR) ((CUR) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_MODULE_STATUS_POE_MODULE_PRESENT_MSB 0
        #define   FORTIUS_M_PFE_REGS_MODULE_STATUS_POE_MODULE_PRESENT_LSB 0
        #define   FORTIUS_M_PFE_REGS_MODULE_STATUS_POE_MODULE_PRESENT_FWIDTH 1
    volatile u_int8_t clkmux_ctrl;		/* 0x25 */
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_PRIMARY_1588_CLKMUX_SEL_SET(CUR, NEWVAL) ((((NEWVAL) << 7) & 0x00000080) | ((CUR) & ~0x00000080))
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_PRIMARY_1588_CLKMUX_SEL_GET(CUR) (((CUR) >> 7) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_PRIMARY_1588_CLKMUX_SEL_MSB 7
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_PRIMARY_1588_CLKMUX_SEL_LSB 7
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_PRIMARY_1588_CLKMUX_SEL_FWIDTH 1
        ...
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_SECONDARY_1588_CLKMUX_SEL_SET(CUR, NEWVAL) ((((NEWVAL) << 3) & 0x00000008) | ((CUR) & ~0x00000008))
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_SECONDARY_1588_CLKMUX_SEL_GET(CUR) (((CUR) >> 3) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_SECONDARY_1588_CLKMUX_SEL_MSB 3
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_SECONDARY_1588_CLKMUX_SEL_LSB 3
        #define   FORTIUS_M_PFE_REGS_CLKMUX_CTRL_SECONDARY_1588_CLKMUX_SEL_FWIDTH 1
    ...
    volatile u_int8_t port_led_rj45_cntrl1;		/* 0x26 */
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT8_RJ45_MODE_SET(CUR, NEWVAL) ((((NEWVAL) << 7) & 0x00000080) | ((CUR) & ~0x00000080))
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT8_RJ45_MODE_GET(CUR) (((CUR) >> 7) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT8_RJ45_MODE_MSB 7
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT8_RJ45_MODE_LSB 7
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT8_RJ45_MODE_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT7_RJ45_MODE_SET(CUR, NEWVAL) ((((NEWVAL) << 6) & 0x00000040) | ((CUR) & ~0x00000040))
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT7_RJ45_MODE_GET(CUR) (((CUR) >> 6) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT7_RJ45_MODE_MSB 6
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT7_RJ45_MODE_LSB 6
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT7_RJ45_MODE_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT6_RJ45_MODE_SET(CUR, NEWVAL) ((((NEWVAL) << 5) & 0x00000020) | ((CUR) & ~0x00000020))
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT6_RJ45_MODE_GET(CUR) (((CUR) >> 5) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT6_RJ45_MODE_MSB 5
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT6_RJ45_MODE_LSB 5
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT6_RJ45_MODE_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT5_RJ45_MODE_SET(CUR, NEWVAL) ((((NEWVAL) << 4) & 0x00000010) | ((CUR) & ~0x00000010))
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT5_RJ45_MODE_GET(CUR) (((CUR) >> 4) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT5_RJ45_MODE_MSB 4
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT5_RJ45_MODE_LSB 4
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT5_RJ45_MODE_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT4_RJ45_MODE_SET(CUR, NEWVAL) ((((NEWVAL) << 3) & 0x00000008) | ((CUR) & ~0x00000008))
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT4_RJ45_MODE_GET(CUR) (((CUR) >> 3) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT4_RJ45_MODE_MSB 3
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT4_RJ45_MODE_LSB 3
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT4_RJ45_MODE_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT3_RJ45_MODE_SET(CUR, NEWVAL) ((((NEWVAL) << 2) & 0x00000004) | ((CUR) & ~0x00000004))
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT3_RJ45_MODE_GET(CUR) (((CUR) >> 2) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT3_RJ45_MODE_MSB 2
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT3_RJ45_MODE_LSB 2
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT3_RJ45_MODE_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT2_RJ45_MODE_SET(CUR, NEWVAL) ((((NEWVAL) << 1) & 0x00000002) | ((CUR) & ~0x00000002))
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT2_RJ45_MODE_GET(CUR) (((CUR) >> 1) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT2_RJ45_MODE_MSB 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT2_RJ45_MODE_LSB 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT2_RJ45_MODE_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT1_RJ45_MODE_SET(CUR, NEWVAL) (((NEWVAL) & 0x00000001) | ((CUR) & ~0x00000001))
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT1_RJ45_MODE_GET(CUR) ((CUR) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT1_RJ45_MODE_MSB 0
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT1_RJ45_MODE_LSB 0
        #define   FORTIUS_M_PFE_REGS_PORT_LED_RJ45_CNTRL1_PORT1_RJ45_MODE_FWIDTH 1
    ...
    volatile u_int8_t traffic_manager_cntrl;		/* 0x2b */
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_EEPROM_EN_SET(CUR, NEWVAL) ((((NEWVAL) << 4) & 0x00000010) | ((CUR) & ~0x00000010))
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_EEPROM_EN_GET(CUR) (((CUR) >> 4) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_EEPROM_EN_MSB 4
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_EEPROM_EN_LSB 4
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_EEPROM_EN_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_DEBUG_MODE_EN_SET(CUR, NEWVAL) ((((NEWVAL) << 3) & 0x00000008) | ((CUR) & ~0x00000008))
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_DEBUG_MODE_EN_GET(CUR) (((CUR) >> 3) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_DEBUG_MODE_EN_MSB 3
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_DEBUG_MODE_EN_LSB 3
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_I2C_DEBUG_MODE_EN_FWIDTH 1
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_MASTER_EN_SET(CUR, NEWVAL) ((((NEWVAL) << 2) & 0x00000004) | ((CUR) & ~0x00000004))
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_MASTER_EN_GET(CUR) (((CUR) >> 2) & 0x00000001)
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_MASTER_EN_MSB 2
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_MASTER_EN_LSB 2
        #define   FORTIUS_M_PFE_REGS_TRAFFIC_MANAGER_CNTRL_TM_MASTER_EN_FWIDTH 1
    ...
    unsigned char    FILLER_0x2d[0x53];
} fortius_m_pfe_regs;
