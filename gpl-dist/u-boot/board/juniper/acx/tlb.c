...
struct fsl_e_tlb_entry tlb_table[] = {
	...
	/* *I*G* - SYSPLD */
	SET_TLB_ENTRY(1, CONFIG_SYS_SYSPLD_BASE, CONFIG_SYS_SYSPLD_BASE,
		      MAS3_SX|MAS3_SW|MAS3_SR, MAS2_I|MAS2_G,
		      0, 3, BOOKE_PAGESZ_4K, 1),
	/* *I*G* - NVRAM First 64K */
	SET_TLB_ENTRY(1, CONFIG_SYS_NVRAM_BASE, CONFIG_SYS_NVRAM_BASE,
		      MAS3_SX|MAS3_SW|MAS3_SR, MAS2_I|MAS2_G,
		      0, 4, BOOKE_PAGESZ_64K, 1),
	/* *I*G* - NVRAM Second 64K */
	SET_TLB_ENTRY(1, CONFIG_SYS_NVRAM_BASE + (64*1024),
		      CONFIG_SYS_NVRAM_BASE + (64*1024),
		      MAS3_SX|MAS3_SW|MAS3_SR, MAS2_I|MAS2_G,
