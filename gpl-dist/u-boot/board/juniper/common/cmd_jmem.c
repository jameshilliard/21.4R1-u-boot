...
/*-----------------------------------------------------*/
int
p_null (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    return 1;
}

int
p_delay (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
    udelay(100000);  /* 100ms */
    return 1;
...
int
u_w0 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r0 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r1 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r0_w1 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
d_r0_w1 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r1_w0 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
d_r1_w0 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
d_r0_w1_w0 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r0_w1_r1 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
d_r0_w1_r1 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r1_w0_w1 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r1_w0_r0 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
d_r1_w0_r0 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r0_w1_w0_w1 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
d_r1_w0_w1_w0 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
int
u_r0_w1_r1_w0_r0_w1 (UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    dprintf("%s\n", __FUNCTION__);
...
void
print_error (int step, UT_SIZE addr, UT_SIZE read, UT_SIZE expected)
{
    int bit;
    UT_SIZE mismatch;
...
/* (w0) */
int
w0 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int i, size;
...
/* (r0) */
int
r0 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r1) */
int
r1 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r0, w1) */
int
r0_w1 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r1, w0) */
int
r1_w0 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r0, w1, w0) */
int
r0_w1_w0 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r0, w1, r1) */
int
r0_w1_r1 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r1, w0, w1) */
int
r1_w0_w1 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r1, w0, r0) */
int
r1_w0_r0 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r0, w1, w0, w1) */
int
r0_w1_w0_w1 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r1, w0, w1, w0) */
int
r1_w0_w1_w0 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
...
/* (r0, w1, r1, w0, r0, w1) */
int
r0_w1_r1_w0_r0_w1 (int direction, UT_SIZE saddr, UT_SIZE eaddr, UT_SIZE pattern)
{
    int result = 1;
    int i, size;
    volatile UT_SIZE *mem;
 ...
 */
int
do_malgo (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
...
#if defined(CONFIG_EX3242) || defined(CONFIG_EX45XX) | defined(CONFIG_EX4300)
    if (mend > (gd->ram_size - (1 << 20))) {
	printf("ERROR: end address 0x%08lx greater than maximum address"
	       "0x%08lx\n",
	       mend, gd->ram_size - (1 << 20));
	return 1;
    }
#endif
 ...
 */
int
memtest (ulong saddr, ulong eaddr, int mloop, int display)
{
 ...
 */
int
do_memtest (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
    ulong start, end;
    int     mloop = 1;
