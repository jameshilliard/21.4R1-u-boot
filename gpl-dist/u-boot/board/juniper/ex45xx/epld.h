...
enum {
    ...
    /* The below are valid only on EX4510 */
    EPLD_FRONT_LED_CTRL = 0x2A,		    /* 0x54 */
    EPLD_MOD_CTRL_PS = 0x2B,		    /* 0x56 */
    EPLD_FAN_CTRL_0_1 = 0x2C,		    /* 0x58 */
    EPLD_FAN_CTRL_2_3 = 0x2D,		    /* 0x5A */
    EPLD_FAN_SPEED_0 = 0x2E,		    /* 0x5C */
    EPLD_FAN_SPEED_1 = 0x2F,		    /* 0x5E */
    EPLD_FAN_SPEED_2 = 0x30,		    /* 0x60 */
    EPLD_FAN_SPEED_3 = 0x31,		    /* 0x62 */
...
/* ADDED for EX4510 */
#define	EPLD_USB_PHY_RST    (1 << 4)
#define	EPLD_USB_HUB_RST    (1 << 5)
#define	EPLD_USB_CONS_RST   (1 << 6)
#define	EPLD_RTC_RST	    (1 << 7)
#define	EPLD_FMOD_I2C_RST   (1 << 8)
#define	EPLD_RMOD_I2C_RST   (1 << 9)
...
/* FAN CONTROLS ON KONA */
#define FAN_0_PRNT			(0x1 << 0)
#define FAN_0_LED_ON		(0x1 << 2)
#define FAN_0_DEFAULT_SPEED	(0x8 << 4)

#define FAN_1_PRNT			(0x1 << 8)
#define FAN_1_LED_ON		(0x1 << 10)
#define FAN_1_DEFAULT_SPEED	(0x8 << 12)

#define FAN_2_PRNT			(0x1 << 0)
#define FAN_2_LED_ON		(0x1 << 2)
#define FAN_2_DEFAULT_SPEED	(0x8 << 4)

#define FAN_3_PRNT			(0x1 << 8)
#define FAN_3_LED_ON		(0x1 << 10)
#define FAN_3_DEFAULT_SPEED	(0x8 << 12)

/* EPLD_BOOT_CTL - ex4550 */
