...
/*
 * Setup LAWs for DDR, used the last available LAWs
 * Caller needs to ensure enough LAWs are present.
 * We are using a max of 5 tlbs for ddr.
 */
int set_ddr_laws(u64 start, u64 sz, enum law_trgt_if id)
{
	u64 start_align, law_sz;
	int law_sz_enc, num_laws = 0;
