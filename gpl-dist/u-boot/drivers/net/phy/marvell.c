...
/* SGMII */
/* Marvell 88E1112S */
static int m88e1112s_config(struct phy_device *phydev)
{
	int reg;
	mdio_mode_select(0x12, 0);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_88E1112_PHY_PAGE, 0x2);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_CONTROL, MIIM_CONTROL_RESET);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_88E1112_PHY_PAGE, 0x0);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_CONTROL, MIIM_CONTROL_RESET);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_GBIT_CONTROL, MIIM_GBIT_CONTROL_INIT);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_ANAR, MIIM_ANAR_INIT);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_CONTROL, MIIM_CONTROL_RESET);
	mii_cr_init(MIIM_CONTROL, MIIM_CONTROL_INIT);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_88E1112_PHY_PAGE, 0x3);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_88E1112_PHY_LED_CONTROL, MIIM_88E1112_PHY_LED_DEFAULT);
	phy_write(phydev, MDIO_DEVAD_NONE, MIIM_88E1112_PHY_PAGE, 0x0);
	mdio_mode_select(0, 0);
}

static int m88e1112s_startup(struct phy_device *phydev)
{
	mdio_mode_select(0x12, 0);
	genphy_update_link(phydev);
	m88e1xxx_parse_status(phydev);
...
/* JUNOS Start */
#ifdef CONFIG_EX4500
static struct phy_driver M88E1112S_driver = {
	.name = "Marvell 88E1112S",
	.uid = 0x01410c9,
	.mask = 0xffffff0,
	.features = PHY_GBIT_FEATURES,
	.config = &m88e1112s_config,
	.startup = &m88e1112s_startup,
	.shutdown = &genphy_shutdown,
};
#endif
/* JUNOS End */
