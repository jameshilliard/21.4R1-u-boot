...
{
	_serial_putc(c, get_console_index());
}
#endif
...
{
	_serial_putc_raw(c, get_console_index());
}
#endif
...
{
	_serial_puts(s, get_console_index());
}
#endif
...
serial_getc(void)
{
	return _serial_getc(get_console_index());
}
#endif
...
serial_tstc(void)
{
	return _serial_tstc(get_console_index());
}
#endif
...
serial_setbrg(void)
{
	_serial_setbrg(get_console_index());
}
#endif
